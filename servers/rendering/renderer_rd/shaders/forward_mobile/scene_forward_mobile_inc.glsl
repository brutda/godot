...
layout(set = 1, binding = 11) uniform texture3D vfog_texture;

layout(set = 1, binding = 12) uniform sampler decal_sampler;

layout(set = 1, binding = 13) uniform sampler light_projector_sampler;
